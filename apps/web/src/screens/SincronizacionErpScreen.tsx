...
const itemsDisponibles: SincronizacionItem[] = [
  ...
  { id: 'tiposInsumo', label: 'Tipos de insumo', descripcion: 'Clasificacion global de insumos.' },
  { id: 'servicios', label: 'Servicios/Labores', descripcion: 'Servicios ERP usados como labores.' },
  { id: 'tiposServicio', label: 'Tipos de servicio', descripcion: 'Clasificacion global de servicios/labores.' },
...
export function SincronizacionErpScreen({
  ...
  const resumen = useMemo(() => ultimoResultadoSync ? [
    ...
    ['Tipos insumo', ultimoResultadoSync.tiposInsumo],
    ['Servicios', ultimoResultadoSync.servicios],
    ['Tipos servicio', ultimoResultadoSync.tiposServicio],

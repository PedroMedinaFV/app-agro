            ...
            insumos: [
              {
                ...
                etapaId: 'etapa-siembra',
                indiceAplicacion: 1,
                insumoAppId: 'insumo-app-semilla-girasol',
...
export function obtenerPlanificacionDemo(clienteId = 'cliente-demo'): PlanificacionSnapshot {
  ...
  snapshotDemo = {
    ...
    lotesApp: [
      ...
      {
        id: 'lote-app-provisorio-1',
        clienteId,
        campoAppId: 'campo-app-provisorio-1',
        nombre: 'LOTE NORTE',
    ...
    actividadesApp: [
      {
        id: 'actividad-app-girasol',
        clienteId,
        empresaErpId: 'empresa:mock',
        actividadErpId: 'empresa:mock:actividad:48',
        especieAppId: 'especie-app-girasol',
        especieErpId: 'empresa:mock:especie:33',
        nombre: 'Girasol',
        codigoInterno: 'GIR',
        estadoVinculacion: 'vinculado_erp',
...
export function guardarProtocoloDemo(id: string, request: GuardarProtocoloRequest): GuardarProtocoloResponse {
  ...
  const resumen = {
    ...
    actividadAppId: protocoloActualizado.actividadAppId,
    ...
    zonaAppId: protocoloActualizado.zonaAppId,
    campoAppId: protocoloActualizado.campoAppId,

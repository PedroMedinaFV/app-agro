...
export async function guardarLaborReferenciaPersistida(
  ...
  return prisma.$transaction(async (tx) => {
    ...
    const guardado = await tx.laborReferencia.upsert({
      where: { id },
      update: {
        empresaErpId: labor.empresaErpId ?? null,
        servicioErpId: labor.servicioErpId ?? null,
        idServicio: labor.idServicio ?? null,
        idTipoServicio: labor.idTipoServicio ?? null,
        codigo: labor.codigo,
        nombre: labor.nombre,
        descripcionAbreviada: labor.descripcionAbreviada ?? null,
        idUnidadMedida: labor.idUnidadMedida ?? null,
        idMoneda: labor.idMoneda ?? null,
        unidadSugerida: labor.unidadSugerida,
        costoUnitarioSugerido: labor.costoUnitarioSugerido ?? null,
        imputaDosis: labor.imputaDosis ?? null,
        estadoVinculacion: labor.estadoVinculacion,
        activo: labor.activo,
        origen: labor.origen,
        fechaUltimaActualizacionErp: labor.fechaUltimaActualizacionErp ? new Date(labor.fechaUltimaActualizacionErp) : null,
